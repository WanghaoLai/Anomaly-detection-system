...
class AlgorithmInfo(Model):
    ...
    docker_image = fields.CharField(max_length=500, null=True, description='Docker 镜像地址')
    docker_image_digest = fields.CharField(max_length=255, null=True, description='Docker 镜像摘要值')
