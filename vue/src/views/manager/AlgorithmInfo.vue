    ...
    <div class="algo-card">
      ...
      <div class="table-area">
        ...
        >
          ...
          <el-table-column label="任务类别" prop="task_category" width="100" align="center" show-overflow-tooltip />
          ...
          <el-table-column label="Python / CUDA" width="120" align="center">
            <template #default="scope">
          ...
          <el-table-column label="入口脚本" width="140" align="center">
            <template #default="scope">
              <div class="cell-stack">
